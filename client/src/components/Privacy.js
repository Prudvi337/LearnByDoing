...
const Privacy = () => {
    return (
        ...
        <p className="para">We collect the following types of information when you use our platform:</p>
        <ul>
        ...
        <p className="para">We use the information we collect for the following purposes:</p>
        <ul>
        ...
        <p className="para">We do not share your personal information with third parties, except in the following situations:</p>
        <ul>
       ...
       className=""      <li>In the event of a business transfer, such as a merger or acquisition, where user information may be transferred as part of the transaction.</li>
        </ul>
        ...
        <p className='para'>You have certain rights regarding the personal information we hold about you. These include:</p>
        <ul>
