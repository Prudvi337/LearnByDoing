...
export default function EnhancedProjectDashboard() {
  ...
  // const sendEmail = (projectTitle, role) => {
  ...
  //       role_name: role,
  //       user_email: user.email, // Use Firebase currentUser email
  //     };

  //     emailjs.send('service_s1qlp46', 'template_2k34pvt', emailParams, 'fUMMOq4HSmGnzvp2H')
  //       .then(() => {
